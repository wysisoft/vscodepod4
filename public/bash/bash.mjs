...
async function createBashModule(moduleArg = {}) {
...
function findWasmBinary() {
  ...
  return new URL('bash.wasm', import.meta.url).href;
...
poll:(stream, timeout, notifyCallback) => {
            var flags = (PTY.readable ? 1 : 0) | (PTY.writable ? 4 : 0);
...
/** @type {function(string, boolean=, number=)} */
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(js_checkpoint|invoke_.*|__asyncjs__.*)$/;
...
var dynCall_viijijijii = makeInvalidEarlyAccess('dynCall_viijijijii');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['sigaction'] != 'undefined', 'missing Wasm export: sigaction');
  ...
  assert(typeof wasmExports['raise'] != 'undefined', 'missing Wasm export: raise');
  ...
  assert(typeof wasmExports['dynCall_viijijijii'] != 'undefined', 'missing Wasm export: dynCall_viijijijii');
  ...
  dynCall_viijijijii = dynCalls['viijijijii'] = createExportWrapper('dynCall_viijijijii', 10);
...
function invoke_viijijijii(index,a1,a2,a3,a4,a5,a6,a7,a8,a9) {
  var sp = stackSave();
  try {
    dynCall_viijijijii(index,a1,a2,a3,a4,a5,a6,a7,a8,a9);
  } catch(e) {
    stackRestore(sp);
    if (!(e instanceof EmscriptenEH)) throw e;
    _setThrew(1, 0);
...
export default createBashModule;
