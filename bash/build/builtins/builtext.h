...
#if defined (ALIAS)
extern int alias_builtin (WORD_LIST *);
extern char * const alias_doc[];
#endif /* ALIAS */
#if defined (ALIAS)
extern int unalias_builtin (WORD_LIST *);
extern char * const unalias_doc[];
#endif /* ALIAS */
#if defined (READLINE)
extern int bind_builtin (WORD_LIST *);
extern char * const bind_doc[];
#endif /* READLINE */
extern int break_builtin (WORD_LIST *);
extern char * const break_doc[];
extern int continue_builtin (WORD_LIST *);
extern char * const continue_doc[];
extern int builtin_builtin (WORD_LIST *);
extern char * const builtin_doc[];
#if defined (DEBUGGER)
extern int caller_builtin (WORD_LIST *);
extern char * const caller_doc[];
#endif /* DEBUGGER */
extern int cd_builtin (WORD_LIST *);
extern char * const cd_doc[];
extern int pwd_builtin (WORD_LIST *);
extern char * const pwd_doc[];
extern int colon_builtin (WORD_LIST *);
extern char * const colon_doc[];
extern int colon_builtin (WORD_LIST *);
extern char * const true_doc[];
extern int false_builtin (WORD_LIST *);
extern char * const false_doc[];
extern int command_builtin (WORD_LIST *);
...
extern int local_builtin (WORD_LIST *);
extern char * const local_doc[];
#if defined (V9_ECHO)
extern int echo_builtin (WORD_LIST *);
...
extern int eval_builtin (WORD_LIST *);
extern char * const eval_doc[];
extern int getopts_builtin (WORD_LIST *);
extern char * const getopts_doc[];
extern int exec_builtin (WORD_LIST *);
extern char * const exec_doc[];
extern int exit_builtin (WORD_LIST *);
extern char * const exit_doc[];
extern int logout_builtin (WORD_LIST *);
extern char * const logout_doc[];
#if defined (HISTORY)
extern int fc_builtin (WORD_LIST *);
extern char * const fc_doc[];
#endif /* HISTORY */
#if defined (JOB_CONTROL)
extern int fg_builtin (WORD_LIST *);
extern char * const fg_doc[];
#endif /* JOB_CONTROL */
#if defined (JOB_CONTROL)
extern int bg_builtin (WORD_LIST *);
extern char * const bg_doc[];
#endif /* JOB_CONTROL */
extern int hash_builtin (WORD_LIST *);
extern char * const hash_doc[];
#if defined (HELP_BUILTIN)
extern int help_builtin (WORD_LIST *);
extern char * const help_doc[];
#endif /* HELP_BUILTIN */
#if defined (HISTORY)
extern int history_builtin (WORD_LIST *);
extern char * const history_doc[];
#endif /* HISTORY */
#if defined (JOB_CONTROL)
extern int jobs_builtin (WORD_LIST *);
extern char * const jobs_doc[];
#endif /* JOB_CONTROL */
#if defined (JOB_CONTROL)
extern int disown_builtin (WORD_LIST *);
extern char * const disown_doc[];
#endif /* JOB_CONTROL */
extern int kill_builtin (WORD_LIST *);
extern char * const kill_doc[];
extern int let_builtin (WORD_LIST *);
extern char * const let_doc[];
extern int read_builtin (WORD_LIST *);
...
extern int export_builtin (WORD_LIST *);
extern char * const export_doc[];
extern int readonly_builtin (WORD_LIST *);
extern char * const readonly_doc[];
extern int shift_builtin (WORD_LIST *);
...
#if defined (JOB_CONTROL)
extern int suspend_builtin (WORD_LIST *);
extern char * const suspend_doc[];
#endif /* JOB_CONTROL */
extern int test_builtin (WORD_LIST *);
extern char * const test_doc[];
extern int test_builtin (WORD_LIST *);
extern char * const test_bracket_doc[];
extern int times_builtin (WORD_LIST *);
...
#if defined (JOB_CONTROL)
extern int wait_builtin (WORD_LIST *);
...
extern int pushd_builtin (WORD_LIST *);
extern char * const pushd_doc[];
#endif /* PUSHD_AND_POPD */
#if defined (PUSHD_AND_POPD)
extern int popd_builtin (WORD_LIST *);
extern char * const popd_doc[];
#endif /* PUSHD_AND_POPD */
#if defined (PUSHD_AND_POPD)
extern int dirs_builtin (WORD_LIST *);
extern char * const dirs_doc[];
#endif /* PUSHD_AND_POPD */
extern int shopt_builtin (WORD_LIST *);
extern char * const shopt_doc[];
extern int printf_builtin (WORD_LIST *);
extern char * const printf_doc[];
#if defined (PROGRAMMABLE_COMPLETION)
extern int complete_builtin (WORD_LIST *);
extern char * const complete_doc[];
#endif /* PROGRAMMABLE_COMPLETION */
#if defined (PROGRAMMABLE_COMPLETION)
extern int compgen_builtin (WORD_LIST *);
extern char * const compgen_doc[];
#endif /* PROGRAMMABLE_COMPLETION */
#if defined (PROGRAMMABLE_COMPLETION)
extern int compopt_builtin (WORD_LIST *);
